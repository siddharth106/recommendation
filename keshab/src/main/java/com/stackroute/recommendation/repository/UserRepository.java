...
public interface UserRepository extends Neo4jRepository<User,Long> {
    ...
    @Query("create (:Question { questionId:{questionId}, questionTitle:{questionTitle},questionDescription:{questionDescription},difficulty:{difficulty},tags:{tags},gitUrl:{gitUrl},language:{language}})")
 public void saveQuestion(@Param("questionId") String questionId,@Param("difficulty") String difficulty,@Param("tags") String tags);
